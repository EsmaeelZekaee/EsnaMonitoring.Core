...
namespace ModbusUtility
{
    ...
    public interface IModbusControl : IDisposable
    {
        ...
        Result ReadUserDefinedRegisters(
            byte unitId,
            byte function,
            ushort address,
            ushort quantity,
        ...
        Result ReadWriteMultipleRegisters(
            byte unitId,
            ushort readAddress,
            ushort readQuantity,
            short[] readRegisters,
        ...
        Result WriteUserDefinedRegisters(
            byte unitId,
            byte function,
            ushort address,
            ushort quantity,
