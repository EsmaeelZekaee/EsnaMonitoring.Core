namespace ModbusUtility
{
    ...
    public class ModbusControl : Component, IModbusControl
    {
        ...
        public ModbusControl()
        {
            ...
            this.Modbus = new Modbus(this.TxRx = new CTxRx(this.port));
            this.TxRx.Mode = Mode.RTU;
        }
        ...
        /// </example>
        /// <remarks>
        ///     A list of valid port names can be obtained using the
        ///     <see cref="M:ModbusMasterLib.WSMBSControl.GetPortNames">GetPortNames</see> method.
        /// </remarks>
        ...
        public int ResponseTimeout
        {
            ...
            set
            {
                if (value >= 100 && value <= 30000) this._ResponseTimeout = value;
            }
        }
        ...
        ///     <para>
        ///         The best practice for any application is to wait for some amount of time after calling the Close method
        ///         before attempting to call the Open method, as the port may not be closed instantly.
        ///     </para>
        /// </summary>
        /// <example>
        ///     <code lang="c#">
        ...
        {
            return this.Res = this.Modbus.DetectDevice(unitId, out name);
        }
        ...
        public async ValueTask<DataResult<string>> DetectDeviceAsync(byte unitId)
        {
            return await Task.Run(
                       () =>
                           {
                               var result = this.DetectDevice(unitId, out var name);
        ...
        public string GetLastErrorString()
        {
            ...
            return "Unknown Error - " + this.Res;
        }

        /// <summary>
        ///     Gets an array of serial port names for the current computer.
        ///     <para>
        ///         Use the GetPortNames method to query the current computer for a list of valid serial port names. For example,
        ///         you can use this method to determine whether COM1 and COM2 are valid serial ports for the current computer.
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         If the function fails, the return value is nonzero. See
        ///         <see cref="T:ModbusMasterLib.Result">WSMBSControl.Result</see>.
        ///     </para>
        /// </returns>
        /// <remarks>
        ...
        ///     <para>
        ///         If the orMask value is zero, the result is simply the logical ANDing of the current contents and
        ///         andMask. If the andMask value is zero, the result is equal to the orMask value.
        ///     </para>
        /// </remarks>
        ...
        ///     <para>
        ///         If the function fails, the return value is nonzero. See
        ///         <see cref="T:ModbusMasterLib.Result">ModbusMasterLib.Result</see>.
        ///     </para>
        /// </returns>
        /// <example>
        ///     <code lang="c#">
        ...
        {
            this.TxRx.Mode = this.Mode;
            try
            {
                this.port.ReadTimeout = this._ResponseTimeout;
                this.port.BaudRate = this.BaudRate;
                this.port.StopBits = (StopBits)this._StopBits;
                this.port.Parity = (System.IO.Ports.Parity)this.Parity;
                this.port.PortName = this.PortName;
                this.port.RtsEnable = this.RTSEnable;
                this.port.DiscardNull = false;
                this.port.DtrEnable = this.DTREnable;
                this.port.Handshake = Handshake.None;
                if (this.TxRx.Mode == Mode.ASCII)
                {
                    if (this._DataBitsSet) this.port.DataBits = this._DataBits;
                    else this.port.DataBits = 7;
                }
                else
                {
                    this._DataBits = 8;
                    this.port.DataBits = this._DataBits;
                }
            ...
            catch (InvalidOperationException ex)
            {
                ...
                return new ValueTask<Result>(this.Res = Result.NOT_AVAILABLE);
            }
            catch (Exception ex2)
            {
            ...
            return new ValueTask<Result>(this.Res = Result.SUCCESS);
        }
        ...
        /// </code>
        /// </example>
        public async ValueTask<DataResult<short[]>> ReadHoldingRegistersAsync(
            byte unitId,
            ushort address,
            ushort quantity)
        {
            return await Task.Run(
                       () =>
                           {
                               var registers = new short[quantity];
                               var result = this.ReadHoldingRegisters(unitId, address, quantity, registers);
        ...
        /// </returns>
        /// <example>
        ///     This example show how to read 10 user defined coils. If function 01 is used then the function do the same as
        ///     ReadCoils.
        ///     <code lang="c#">
        /// bool[] coils = new bool[10];
        /// ModbusMasterLib.Result Result;
        ...
        /// </returns>
        /// <example>
        ///     This example show how to read 10 user defined registers. If function 03 is used then the function do the same as
        ...
        ///     <code lang="cpp">
        /// array<Int16>
        ///             ^ readRegisters = gcnew array
        ///             <Int16>
        ///                 (10);
        ///                 array
        ///                 <Int16>
        ///                     ^ writeRegisters = gcnew array
        ///                     <Int16>
        ///                         (10);
        ///                         ModbusMasterLib::Result Result;
        ///                         for (int i = 0; i
        ///                         < 10; i++)
        ///                             writeRegisters[ i]= i;
        ///                             Result= wsmbsControl1->
        ///                             ReadWriteMultipleRegisters(1, 0, 10, readRegisters, 0, 10, writeRegisters);
        /// </code>
        /// </example>
        ...
        {
            return this.Res = this.Modbus.ReadWriteMultipleRegisters(
                       unitId,
                       readAddress,
                       readQuantity,
                       readRegisters,
        ...
        public float RegistersToFloat(short hiReg, short loReg)
        {
            return BitConverter.ToSingle(
                BitConverter.GetBytes(loReg).Concat(BitConverter.GetBytes(hiReg)).ToArray(),
                0);
        }
        ...
        {
            return BitConverter.ToInt32(BitConverter.GetBytes(loReg).Concat(BitConverter.GetBytes(hiReg)).ToArray(), 0);
        }
        ...
        /// Byte byteCount;                                                    // Hold the number of bytes returned in deviceSpecific
        /// array<Byte>
        ///             ^ deviceSpecific = gcnew array
        ///             <Byte>
        ///                 (100);  // Be sure the size of this array is big enough
        ///                 res = wsmbsControl1->ReportSlaveID(1, byteCount, deviceSpecific);
        /// </code>
        /// </example>
        /// <remarks>
        ///     byteCount receive the size of the slave ID data. deviceSpecific[0] = Slave ID, deviceSpecific[1] = Run
        ///     indicator.
        /// </remarks>
        ...
        ///                     coils[ i]= true;
        ///                     Result= wsmbsControl1->
        ///                     WriteMultipleCoils(1, 0, 10, coils);
        /// </code>
        /// </example>
        ...
        ///                     coils[ i]= true;
        ///                     Result= wsmbsControl1->
        ///                     WriteMultipleCoils(1, 0, 10, coils, 0);
        /// </code>
        /// </example>
        ...
        ///                     registers[ i]= i;
        ///                     Result= wsmbsControl1->
        ///                     WriteMultipleRegisters(1, 0, 10, registers);
        /// </code>
        /// </example>
        public Result WriteMultipleRegisters(byte unitId, ushort address, ushort quantity, short[] registers)
        {
            return this.Res = this.Modbus.WriteRegisters(unitId, 16, address, quantity, registers, 0);
        }
        ...
        ///                     registers[ i]= i;
        ///                     Result= wsmbsControl1->
        ///                     WriteMultipleRegisters(1, 0, 10, registers, 0);
        /// </code>
        /// </example>
        public Result WriteMultipleRegisters(
            ...
            int offset)
        {
            return this.Res = this.Modbus.WriteRegisters(unitId, 16, address, quantity, registers, offset);
        }
        ...
        ///                     coils[ i]= true;
        ///                     Result= wsmbsControl1->
        ///                     WriteUserDefinedCoils(1, 15, 0, 10, coils);
        /// </code>
        /// </example>
        ...
        ///                     coils[ i]= true;
        ///                     Result= wsmbsControl1->
        ///                     WriteUserDefinedCoils(1, 15, 0, 10, coils, 0);
        /// </code>
        /// </example>
        ...
        ///                     registers[ i]= i;
        ///                     Result= wsmbsControl1->
        ///                     WriteUserDefinedRegisters(1, 16, 0, 10, registers);
        /// </code>
        /// </example>
        ...
        ///                     registers[ i]= i;
        ///                     Result= wsmbsControl1->
        ///                     WriteUserDefinedRegisters(1, 16, 0, 10, registers, 0);
        /// </code>
        /// </example>
        public Result WriteUserDefinedRegisters(
            byte unitId,
